...
export default function LandingPage({ onStart, onNavigateToWindDown, onNavigateToDummy }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#FFFDBD' }}>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight text-[#096b17] font-bold animate-[fadeInUp_0.8s_ease-out_0.1s_both]">
                If you are feeling anxious even on normal days...
              </h1>

              {/* Subline - Appears Second */}
              <p className="text-base sm:text-lg md:text-xl text-[#096b17]/80 leading-relaxed max-w-2xl mx-auto animate-[fadeInUp_0.8s_ease-out_0.3s_both]">
                it is our medical recommendation that you take a short wind-down so your answers are accurate
              </p>

              {/* CTAs - Appear Third - Both Same Style */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-4 animate-[fadeInUp_0.8s_ease-out_0.5s_both]">
                <Button
                  ...
                  size="lg"
                  className="w-full sm:w-auto bg-[#096b17] hover:bg-[#075110] text-white px-6 sm:px-8 h-12 sm:h-14 rounded-xl font-semibold transition-all duration-300 cursor-pointer shadow-md hover:shadow-lg text-sm sm:text-base"
                >
