...
export function Hero({ onBookAppointment }: HeroProps) {
  ...
  return (
    ...
    >
      {/* Simplified background - static elements for faster LCP */}
      <div className="absolute inset-0">
        {/* Static glowing orbs - no animation for faster render */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-white rounded-full blur-3xl opacity-10" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#64CB81] rounded-full blur-3xl opacity-10" />
      </div>
